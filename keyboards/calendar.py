...
class CalendarKeyboard:
    ...
    def build(year: int, month: int, callback_prefix: str):
        ...
        days_row = [InlineKeyboardButton(d, callback_data="noop") for d in CalendarKeyboard.DAY_NAMES]
        ...
        for week in cal:
            ...
            for day in week:
                if day == 0:
                    ...
                    row.append(InlineKeyboardButton(str(day), callback_data=f"{callback_prefix}{year}_{month}_{day}"))
            keyboard.append(row)
